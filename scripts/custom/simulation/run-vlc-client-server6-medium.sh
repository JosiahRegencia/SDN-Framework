...
vlcclogfilename="/home/ubuntu/thesis/SDNQoS/test.results/$datetimestr-case$usecase/logs/run-vlc-client-medium-$portToUse-$clientname.$datetimestr.log"
...
cvlc -vvv --file-logging --logfile=$vlcslogfilename --intf rc --rc-host=$hostname:$portToUse -Vdummy --noaudio --novideo --rc-fake-tty --no-sout-display-video --no-sout-display-audio --no-playlist-autostart --no-video-deco --no-embedded-video --input-repeat=5 --quiet rtsp://10.0.1.106:5004/SpringMedium &
